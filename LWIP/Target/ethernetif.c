...
#ifdef SKIP_PHY_INIT
  /* Simulation: skip PHY + disable ETH interrupt that was enabled in HAL_ETH_Init */
...
#ifdef SKIP_ETH_INTERRUPT
    /* Disable ETH interrupt in Renode simulation to avoid ISR storm */
    HAL_NVIC_DisableIRQ(ETH_IRQn);
#endif
